...
<!-- <template>
  <div>
    <h1>
      <template v-for="word in separatedWords">
        {{ word }}
      </template>
    </h1>
  </div>
...
<!--
<iframe src="[YourWidgetURL]" width="560" height="315"></iframe>
-->
...
// const separatedWords = ref([])
//
// separatedWords.value = params.slug.split('&&')
</script>
