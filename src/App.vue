        ...
        meta: [
            {
                ...
                name: 'description',
                content:
                    'One ecosis wallet is a simple, highly secure, non-custodial crypto wallet for storing AVAX.',
            },
            {
                vmid: 'og:description',
                name: 'description',
            ...
            },
            {
                vmid: 'og:title',
                name: 'og:title',
                content: 'The All-in-One ecosis Wallet | One',
            },
        ],
        title: 'The All-in-One ecosis Wallet',
        titleTemplate: '%s | One',
    },
}
</script>
