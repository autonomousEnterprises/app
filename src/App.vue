...
<template>
  <div class="min-h-screen w-full bg-base-200" :data-theme="themeStore.theme">
    <div class="drawer">
      ...
      <div class="drawer-content flex flex-col">
        ...
        <!-- Page content here -->
        <section class="container mx-auto py-16 flex justify-center overflow">
          <RouterView/>
        </section>
      </div>
    ...
    <div class="toast toast-end">
      <div class="alert shadow" v-for="notification in notificationStore.notifications" :class="getNotifcationType(notification.type)" @click="notificationStore.closeNotification(notification)">
        <svg v-if="notification.type === 'standard'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="stroke-info shrink-0 w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
